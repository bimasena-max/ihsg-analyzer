        ...
        <div key={i} style={{
          ...
          {bst && (
            <div style={{ marginTop: 6, paddingTop: 6, borderTop: '1px solid rgba(255,255,255,.05)', display: 'flex', gap: '1rem', flexWrap: 'wrap', fontSize: '.67rem', color: 'var(--muted)' }}>
              ...
              {['3d','5d','7d','14d','30d','60d'].filter(h => bst.byHorizon?.[h]).map(h => {
  ...
  useEffect(() => {
    ...
    if (showBB) {
      ...
      ['upper', 'lower'].forEach(k => {
        ...
        bb.forEach((b, i) => {
          if (b[k] != null) {
            if (i === 0 || !bb[i - 1][k]) ctx.moveTo(x(i), y(b[k]));
...
export default function App() {
  ...
  const [sigHorizon, setSigHorizon] = useState('best');       // 'best' | '3d' | '5d' | '7d' | '14d' | '30d' | '60d'
  const [lbSort, setLbSort] = useState('winrate');            // 'winrate' | 'avgret' | 'score' | 'count'
                ...
                <div>
                  ...
                  <div style={{ display:'flex', gap:10, marginBottom:'1rem', flexWrap:'wrap', alignItems:'center' }}>
                    ...
                    <div style={{ display:'flex', gap:6, alignItems:'center' }}>
                      ...
                      {[['best','⭐ Terbaik'],['3d','3 Hari'],['5d','5 Hari'],['7d','7 Hari'],['14d','14 Hari'],['30d','30 Hari'],['60d','60 Hari']].map(([id,label]) => (
                    ...
                    <div style={{ display:'flex', gap:6, alignItems:'center', marginLeft:'auto' }}>
                      ...
                      {[['winrate','📊 Winrate'],['avgret','💰 Avg Return'],['score','⭐ Score'],['count','📈 Sample']].map(([id,label]) => (
