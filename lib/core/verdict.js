...
// Di-export supaya screener.js bisa pakai skor teknikal yang SAMA dengan
// yang dipakai unified verdict engine — bukan formula ke-3 yang beda lagi.
export function scoreTechnical(snap) {
  if (!snap) return null;
  let s = 50;
  const notes = [];
